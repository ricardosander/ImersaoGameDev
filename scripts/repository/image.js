class ImageRepository {
  preload() {
    ...
    this.particlesImage1 = loadImage(
      "assets/images/set/parallax/03_Particles.png"
    );
    this.forestImage1 = loadImage("assets/images/set/parallax/04_Forest.png");
    this.particlesImage2 = loadImage(
      "assets/images/set/parallax/05_Particles.png"
    );
    ...
    this.flyingDropletImage = loadImage(
      "assets/images/foes/flying_droplet.png"
    );
